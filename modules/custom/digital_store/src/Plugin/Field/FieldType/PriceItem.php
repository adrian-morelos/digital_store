...
namespace Drupal\digital_store\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'digital_store' field type.
 *
 * @FieldType(
 *   id = "price",
...
class PriceItem extends FieldItemBase {
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    $currencies = \Drupal::entityTypeManager()->getStorage('currency')->loadMultiple();
