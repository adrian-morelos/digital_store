...
final class CreditCard {
   ...
   *
   * @var \Drupal\digital_store_payment\CreditCardType[]
   */
  public static $types = [];
   ...
   *
   * @return \Drupal\digital_store_payment\CreditCardType
  ...
  public static function getTypeLabels() {
    ...
    $type_labels = array_map(function ($type) {
      /* @var \Drupal\digital_store_payment\CreditCardType $type */
   ...
   *
   * @return \Drupal\digital_store_payment\CreditCardType|null
   ...
   * @param string $number
   *   The credit card number.
   * @param \Drupal\digital_store_payment\CreditCardType $type
   *   The credit card type.
   *
   * @return bool
